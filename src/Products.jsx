                ...
                <div className="w-50">
                    {product.length>0 && ( 
                        product.map((p)=>{
                            return (
                                <li className="d-flex">
                                    <img src={p.image} width={'90px'} height={'120px'} alt="" />
                                    <div className="p-3">
                                        ...
                                        <h4>&#163;{p.price}</h4>
                                        {
                                            isProductInCart(p) && (
                                                <>
                                                    <button onClick={()=>{decre(p)}} className="btn btn-outline-success">-</button>
                                        ...
                                        {
                                            !isProductInCart(p) && (<button onClick={()=>{addToCart(p)}} className="btn btn-outline-danger">Add To Cart</button>)
                                        }
                                    </div>
                                </li>
                            )
