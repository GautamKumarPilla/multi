...
import NewCountriesCol9 from "./CountriesCol";
...
let NewCountries =()=>{
    ...
    var handleCheck =(c)=>{
        ...
        //     let a = displayCheckRegion.filter(z=>c.target.value!=z)
        //     displayCheckRegion = setDisplayCheckRegion([...a]);
        // }
        // else{
        //     setDisplayCheckRegion([...checkRegion,c.target.value]);
        // }
        if(c.target.checked===false){
