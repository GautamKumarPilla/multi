...
const Hostel = () => {
  ...
  return (
    ...
    <div className='d-flex w-75 mx-auto me-0 my-2'>     
       ...
       <div className="input-group-sm mt-1">
           <input type="text" className="form-control" placeholder="Type here" value={data} onChange={(z)=> setData(z.target.value)}></input>
        </div>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" value="Search" className='btn btn-outline-dark border border-primary border-2' onClick={searchHandler}/>&nbsp;&nbsp;&nbsp;
    ...
    <div className='d-flex w-75 ms-auto'>
      <button className='btn btn-outline-success'>ADD ROOM</button>&nbsp;&nbsp;&nbsp;
      <button className='btn btn-outline-success' onClick={()=>{navigate('/AddBed')}}>ADD BED</button>&nbsp;&nbsp;&nbsp;
      <button className='btn btn-outline-success'>ADD TENANT</button>
    </div>
    </div>
  )
}
